# ARCHITECT (Principal Blueprint)

> [!IMPORTANT]
> This document is the source of truth for high-level architecture, UX flows, and design systems. Generated by the Principal Architect and consumed by the Lead Engineer.

## 1. System Philosophy (AI-OS)
- **Concept**: AI-OS is an autonomous operating system for AI agents (e.g., Antigravity/agy and Claude Code). It transforms standalone CLIs into a highly structured, self-regulating team of experts governed by ACID-compliant state and strict architectural sovereignty.
...
- **Execution**: User prompts the Engineer -> Engineer loads JIT blueprints, implements tasks via Fuzzy Patching, and logs activity to `.ai/LOG.md`.
