...
- **Standard domains**: `core.md`, `security.md`, `agents.md`, `mcp.md`, `workspace.md`, `bootloader.md`, `capabilities.md`, `interop.md`, `caching.md`, `structured-outputs.md` (adapt to project needs).
