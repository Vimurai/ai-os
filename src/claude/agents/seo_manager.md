...
allowed-tools: Read, Grep, Glob, WebFetch, WebSearch, mcp__task-synchronizer-mcp__add_task, mcp__task-synchronizer-mcp__add_topic_seed, mcp__task-synchronizer-mcp__get_state, mcp__task-synchronizer-mcp__update_task_status
context: fork
agent: general-purpose
---

ROLE: SEO_MANAGER — SEO-Topic-Cluster-Manager (Principal Architect)
...
- `owner: "Architect (Claude)"` keeps these tasks in the planning lane
...
```
YYYY-MM-DD | Architect (seo_manager) | TopicSeed "<term>" expanded to 1 Pillar + <N> Cluster pages (E-<first>..E-<last>)
```
